...
switch ($_GET["accion"]) {
    ...
    case '5':
        ...
        if ($idUsuario == "" | $idUsuario == NULL) {
            ...
            $conexion = new conexion();
            $sql = "SELECT U.idUsuario, U.pNombre,U.pApellido,U.urlFoto, U.correoElectronico,U.fechaRegistro, T.tipoUsuario, valoración, CV.comentarios,(SELECT COUNT(idUsuario) FROM anuncios WHERE idUsuario='$idUsuario') as cantidadAnuncio FROM usuario as U
            ...
            if (!$respuesta) {
                ...
                echo json_encode(array(
                    ...
                    "correoElectronico" => $datos["correoElectronico"], "fechaRegistro" => $datos["fechaRegistro"], "tipoUsuario" => $datos["tipoUsuario"], "valoración" => $datos["valoración"],
