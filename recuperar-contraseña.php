            ...
            <div class="body">
                <form id="recuperar_contraseña">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="email" id="txt_correo" class="form-control" name="email" placeholder="Correo electrónico" required autofocus>
                        </div>
                    </div>

                    <button class="btn btn-block btn-lg bg-pink waves-effect" type="submit" id="enviar">Restablecer mi contraseña</button>
