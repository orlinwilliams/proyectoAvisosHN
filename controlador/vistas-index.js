...
/*
estrella = function(){$('#infoArticulo').starrr({
    rating: 2,
...
*/
//+"<script>$('#estrella').starrr({rating:2,change:function(e,valor){console.log(valor); var estrellas=valor; $.ajax({url:'../clases/vistas-index.php?accion=4',method: 'post', data: 'valoracion='+estrellas,success: function(resp){console.log(resp)}})}});</script>"
